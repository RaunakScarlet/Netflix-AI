...
dispatch(toggleLanguage(e.target.value));
    ...
    return (
        <div className="absolute w-screen px-8 py-2 bg-gradient-to-b from-black z-10 flex flex-col md:flex-row justify-between bg-black md:bg-black md:bg-opacity-0">
            <img
            ...
            {user && (
                <div className="flex p-2 justify-between">
                    ...
                    <button
                        ...
                        className=" py-2 px-4 mx-4 my-2 bg-blue-600 text-white rounded-lg"
                    >
